...
class ActivityMetaData:
    ...
    def __post_init__(self):
        ...
        if self.data_file is None:
            # Note: data_file is where the GPX file generated by Pyft *should* be; it still needs to be created,
            # and this should be done in Activity.__init__
            self.data_file = os.path.join(self.config.gpx_file_dir, f'{self.file_name}.gpx')
