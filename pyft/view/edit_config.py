...
from wtforms import StringField, FloatField, SelectField, SubmitField, FileField, TextAreaField
...
class ConfigForm(FlaskForm):
    ...
    distance_unit = SelectField('Preferred unit of distance', choices=(('km', 'kilometre'), ('mile', 'mile')))
